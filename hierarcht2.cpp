...
class ElectronicGadget:public Product{
    public:
    void calcTotalE(){
        cout<<fixed<<setprecision(2)<<"Electronic Cost: "<<"Rs. "<<(cost - (cost * discount))<<endl;
    }
...
class MechanicalDevice:public Product{
    public:
    float costm,discountm;
    void get2(){
        cin>>costm>>discountm;
    }
    void calcTotalM(){
        cout<<fixed<<setprecision(2)<<"Mechanical Cost: "<<"Rs. "<<(costm-(costm * discountm))<<endl;
    }
