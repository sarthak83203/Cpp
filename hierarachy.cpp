...
class Class1:public Circle{
    public:
    Class1(float p):Circle(p){
        
    }
    void calculate(){
        cout<<fixed<<setprecision(2)<<"Class 1: "<<(2 * 3.14159 * radius)<<endl;
    }
    
};
class Class2:public Circle{
    public:
    Class2(float p):Circle(p){
        
    }
    void calculate1(){
        cout<<fixed<<setprecision(2)<<"Class 2: "<<(23.14 * radius)<<endl;
    }
